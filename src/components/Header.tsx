...
const Header = () => {
  ...
  return <>
      <header className="bg-white bg-opacity-90 backdrop-blur-sm shadow-md fixed top-0 left-0 right-0 z-50">
        ...
        {!isMobile && <div className="absolute left-0 right-0 top-full z-50 bg-white/90 backdrop-blur-[8.4px] border-t border-white/43 shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
