...
const SeatPicker = ({ onChange, initialCount }: SeatPickerProps) => {
  ...
  return (
    <div className="w-full space-y-2" ref={seatPickerRef}>
      ...
      {isOpen && (
        <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 space-y-6 bg-white dark:bg-gray-800 shadow-lg">
          {/* Adult row */}
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">{t("booking.passenger.adult", "Adult")}</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm">18-59</p>
            </div>
            <div className="flex items-center space-x-4">
              <Button
                ...
                variant="outline"
                size="icon"
                className="rounded-full h-10 w-10 border-gray-300 dark:border-gray-600 hover:bg-white dark:hover:bg-gray-700 hover:text-primary hover:border-primary"
              ...
              <span className="text-xl w-8 text-center dark:text-white">{counts.adults}</span>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">{t("booking.passenger.child", "Child")}</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm">0-17</p>
            </div>
            <div className="flex items-center space-x-4">
              <Button
              ...
              <span className="text-xl w-8 text-center dark:text-white">{counts.children}</span>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">{t("booking.passenger.senior", "Senior")}</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm">60+</p>
            </div>
            <div className="flex items-center space-x-4">
              <Button
              ...
              <span className="text-xl w-8 text-center dark:text-white">{counts.seniors}</span>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400">{t("booking.form.maxPassengersInfo", "Maximum {{max}} passengers per booking", {max: MAX_PASSENGERS})}</p>
        </div>
      )}
    </div>
  );
